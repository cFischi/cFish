...
Example: `u5.3-data-migration-20250313.js`

### Components Explained

1. **Company Prefix**: 
   - `U` - UcFish trust? + holdingz companY 
   - `iz` - tYFeAiz
   - `FH` - FiscHouse
   - `W` - UcWebZ
   - `UZ` - the UZ
...
2. **Department Number**:
   ...
   - `3` - Physical Operations (OPz)
   - `4` - Production (PRO)
   - `5` - Data Management (DMT)
   - `6` - Social Media/Communications (SMC)
   - `7` - Specialized Operations (SPEC)
...
4. **Task Identifier**:
   -  shortest Abbreviations possible, while keeping context.
   - Brief, hyphen-separated description of file purpose
   - Use lowercase letters and hyphens (kebab-case)

5. **Date** (optional):
   - only on physical documents, and procedures; never on digital items/files.
   - Format: MMDDYY
