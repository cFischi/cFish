                ...
                <article id="post-<?php the_ID(); ?>" class="post-items">
                    ...
                    <figure class="post-image post-image-absolute">
                        <div class="featured-image">
                            <a href="<?php the_permalink(); ?>" class="post-hover">
                    ...
                    <div class="post-content">
                        <div class="post-meta">
                            ...
                            <span class="post-date">
                                <a href="<?php echo esc_url(get_day_link(get_post_time('Y'), get_post_time('m'), get_post_time('j')));  ?>"><?php printf( __( '<span>%s</span><br/>', 'bloovo' ), get_the_modified_date( 'j' ) ); printf( __( '%s', 'bloovo' ), get_the_modified_date( 'F Y' ) ); ?></a>
                            </span>
