                    ...
                    <div class="main-table-cell">
                        <div class="container">
                            <div class="main-content text-left">
                                ...
                                <a data-animation="fadeInUp" data-delay="1300ms" href="<?php echo esc_url( $button1_link ); ?>" class="btn btn-primary theme_btn" <?php if($button1_target){ echo 'target="_blank"';} ?>><span><?php echo esc_html( $button1_label ); ?></span></a>
                                <?php } ?>

                                <?php if($button2_label!=''){ ?>
                                <a data-animation="fadeInUp" data-delay="1300ms" href="<?php echo esc_url( $button2_link ); ?>" class="btn btn-primary theme_btn" <?php if($button2_target){ echo 'target="_blank"';} ?>><span><?php echo esc_html( $button2_label ); ?></span></a>
