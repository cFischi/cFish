...
function bantry_define_color_annotations( $colors ) {
	// Background Color
 ...
 */
function bantry_custom_colors_extra_css() {
...
add_theme_support( 'custom_colors_extra_css', 'bantry_custom_colors_extra_css' );
