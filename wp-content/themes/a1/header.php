                    ...
                    <div class="row d-flex flex-md-row flex-column justify-content-between">
                        <div class="col-md-12 col-sm-12">
                            <div class="row d-flex flex-md-row flex-column justify-content-between">
                                ...
                                <?php if($a1_options) : ?>
                                <div class="col-md-8 col-sm-8 ccol-12 location-part">
                                    
                                    <?php if(get_theme_mod('theme_phone_number',$a1_options['phone'])!='') : ?>
                                        <p><i class="fa fa-phone"></i><?php echo esc_html(get_theme_mod('theme_phone_number',$a1_options['phone'])); ?></p>
                                    <?php endif;
                                        if (get_theme_mod('theme_email_id',$a1_options['email'])!=''): ?>
                                        <p class="top-header-email"><i class="fa fa-envelope-o"></i><a href="mailto:<?php echo esc_attr($a1_options['email']); ?>"><?php echo esc_html(get_theme_mod('theme_email_id',$a1_options['email'])); ?></a></p>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                </div>
