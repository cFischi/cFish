	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
	   ...
	   <?php  for($a1_i=1; $a1_i <= 5 ;$a1_i++ ){ 
	    ...
	    if($sliderimage_image!=''){		
			...
			<?php if(($sliderimage_image_url!='')&&($sliderimage_link!='')&&($sliderimage_content!='')){?>
		  <div class="carousel-item <?php if($a1_loop_active==1){ echo'active'; } ?>">
			 <img src="<?php echo esc_url($sliderimage_image_url[0]);?>" width="100%" height="100%" alt="<?php esc_attr_e('First slide','a1') ?>">
			 <div class="blur-effect"></div>
			 <div class="col-md-12 banner-text">
			 <?php if($sliderimage_title!='') { ?>
				 <h1><?php echo esc_html($sliderimage_title); ?></h1>
				 <div class="circle-border"><span class="fa fa-circle"></span></div>    
			 <?php }
			  if($sliderimage_content!='' || $sliderimage_link!='') { ?><a href="<?php echo esc_url($sliderimage_link); ?>"><?php echo esc_html($sliderimage_content); ?></a><?php } ?>
			 </div>
		  </div>
	   <?php }}} ?>   
	   </div>
...
<div class="col-md-12 home-feature">
	<div class="container a1-container">
		<?php if(get_theme_mod ( 'a1_homepage_section_title',$a1_options['coretitle'])!='' || get_theme_mod ( 'a1_homepage_section_desc',$a1_options['corecaption']) !='') { ?>
                        <div class="col-md-8 offset-md-2 feature-top">
				<?php if(get_theme_mod ( 'a1_homepage_section_title',$a1_options['coretitle'])!='' ) { ?>
				<h2 class="home-heading"><?php echo esc_html(get_theme_mod ( 'a1_homepage_section_title',$a1_options['coretitle'])); ?></h2>
				<div class="circle-border"><span class="fa fa-circle"></span></div>
				<?php } if(get_theme_mod ( 'a1_homepage_section_desc',$a1_options['corecaption']) !='') { echo '<p>'.esc_html(get_theme_mod ( 'a1_homepage_section_desc',$a1_options['corecaption'])).'</p>'; } ?>
			</div>
		<?php } ?>
		<div class="col-md-12 no-padding-lr">
			<div class="row feature-row1 d-flex flex-md-row flex-column justify-content-between">
...
<div class="col-md-12 home-product">
	...
	<?php if( get_theme_mod ('a1_homepage_second_section_title',$a1_options['producttitle'])!='' || get_theme_mod ( 'a1_homepage_second_section_caption',$a1_options['productcaption'])!='') { ?>	
		<div class="col-md-8 offset-md-2 col-12 feature-top">
			<?php if(get_theme_mod ('a1_homepage_second_section_title',$a1_options['producttitle'])!='') { ?>
			<h2 class="home-heading"><?php echo esc_html(get_theme_mod ('a1_homepage_second_section_title',$a1_options['producttitle'])); ?></h2>
			<div class="circle-border"><span class="fa fa-circle"></span></div>
			<?php } if(get_theme_mod ( 'a1_homepage_second_section_caption',$a1_options['productcaption'])!='') { echo '<p>'.esc_html(get_theme_mod ( 'a1_homepage_second_section_caption',$a1_options['productcaption'])).'</p>'; } ?>
		</div>
	<?php } ?>
		<div class="row d-flex flex-md-row flex-column justify-content-between">
		<?php if(get_theme_mod ( 'a1_homepage_second_section_desc',$a1_options['productcontent'])!='') { echo '<div class="col-md-7 col-sm-7 description-left col-12">'.esc_html(get_theme_mod ( 'a1_homepage_second_section_desc',$a1_options['productcontent'])).'</div>'; } 

			if(get_theme_mod ( 'a1_homepage_second_section_email',$a1_options['product-form-email'])!='') { ?>
			<div class="col-md-4 col-sm-4 col-12 col-md-offset-1 col-sm-offset-1 description-right">
	...
	<div class="container a1-container a1-get-touch-home"> 
		...
		<?php if(get_theme_mod ( 'a1_homepage_third_section_image',isset($a1_options['get-touch-logo'])?a1_get_image_id($a1_options['get-touch-logo']):'')!='') { 
			...
			<div class="logo-contact">
				<img src="<?php echo esc_url(isset($sliderimage_image_url[0])); ?>" alt="">
			</div>
		<?php } ?> 
