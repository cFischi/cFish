jQuery(function() {
	...
	jQuery(document).ready(function() {
		...
		jQuery('input[name="ig-select-trial-template"]').on('click', function(e){
	...
	jQuery('.ig_campaign_update, .ig_campaign_publish, .ig_campaign_switch_draft, .ig_campaign_save').on('click', function(e){
